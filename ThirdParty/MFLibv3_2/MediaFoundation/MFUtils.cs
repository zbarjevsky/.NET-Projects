...
namespace MediaFoundation.Misc
{
    ...
    public static class MFError
    {
        ...
        public static void ThrowExceptionForHR(HResult hr)
        {
            ...
            if (hr < 0)
            {
                string s = GetErrorText((int)hr);

                // If a string is returned, build a COM error from it
                if (s != null)
                {
                    throw new COMException(s, (int)hr);
                }
                else
                {
    ...
    {
        public const HResult S_Ok = HResult.S_OK;
        public const HResult S_False = HResult.S_FALSE;

        public const HResult E_NotImplemented = HResult.E_NOTIMPL; // unchecked((int)0x80004001);
        public const HResult E_NoInterface = HResult.E_NOINTERFACE; //unchecked((int)0x80004002);
        public const HResult E_Pointer = HResult.E_POINTER; //unchecked((int)0x80004003);
        public const HResult E_Abort = HResult.E_ABORT; //unchecked((int)0x80004004);
        public const HResult E_Fail = HResult.E_FAIL; //unchecked((int)0x80004005);
        public const HResult E_Unexpected = HResult.E_UNEXPECTED; //unchecked((int)0x8000FFFF);
        public const HResult E_OutOfMemory = HResult.E_OUTOFMEMORY; //unchecked((int)0x8007000E);
        public const HResult E_InvalidArgument = HResult.E_INVALIDARG; //unchecked((int)0x80070057);
        public const HResult E_BufferTooSmall = HResult.MF_E_BUFFERTOOSMALL; //unchecked((int)0x8007007a);
