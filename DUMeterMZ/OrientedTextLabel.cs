...
namespace OrientableText
{
	...
	public class OrientedTextLabel : System.Windows.Forms.Label
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
            ...
            stringFormat.Alignment = TextAlign2StringAlign(this.TextAlign);
        ...
        private StringAlignment TextAlign2StringAlign(ContentAlignment align)
        {
            switch (align)
            {
    ...
    }//end class OrientedTextLabel
}//end namespace OrientableText
