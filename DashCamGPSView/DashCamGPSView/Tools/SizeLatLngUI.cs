...
namespace DashCam.Tools
{
   ...
   public struct SizeLatLng
   {
      ...
      public SizeLatLng(PointLatLngUI pt)
      {
      ...
      public static explicit operator PointLatLngUI(SizeLatLng size)
      {
         return new PointLatLngUI(size.HeightLat, size.WidthLng);
      }
      ...
      public PointLatLngUI ToPointLatLng()
      {
         return (PointLatLngUI) this;
      }
