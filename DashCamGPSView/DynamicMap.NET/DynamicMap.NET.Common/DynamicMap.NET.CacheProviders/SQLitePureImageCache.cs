...
namespace DynamicMap.NET.CacheProviders
{
#if SQLite
   ...
   public class SQLitePureImageCache : PureImageCache
   {
      ...
      public string CacheLocation
      {
         ...
         set
         {
            ...
            dir = gtileCache + DynMapProvider.LanguageStr + Path.DirectorySeparatorChar;
      ...
      bool PureImageCache.PutImageToCache(byte[] tile, int type, DynPoint pos, int zoom)
      {
         bool ret = true;
         if(Created)
         {
      ...
      PureImage PureImageCache.GetImageFromCache(int type, DynPoint pos, int zoom)
      {
         PureImage ret = null;
         try
         {
