...
namespace DynamicMap.NET.Internals
{
    ...
    public class Stuff
    {
        ...
        static string EncryptString(string Message, string Passphrase)
        {
            ...
            using (var HashProvider = new SHA1CryptoServiceProvider())
            {
                ...
                using (TripleDESCryptoServiceProvider TDESAlgorithm = new TripleDESCryptoServiceProvider())
                {
                    ...
                    {
                        Debug.WriteLine("Exception during Stuff::EncryptString: " + err.ToString());
                        throw;
                    }
                    finally
                    {
        ...
        static string DecryptString(string Message, string Passphrase)
        {
            ...
            using (var HashProvider = new SHA1CryptoServiceProvider())
            {
                ...
                using (TripleDESCryptoServiceProvider TDESAlgorithm = new TripleDESCryptoServiceProvider())
                {
                    ...
                    {
                        Debug.WriteLine("Exception during Stuff::DecryptString: " + err.ToString());
                        throw;
                    }
                    finally
                    {
        ...
        public static string EncriptedPasswordString(string Message)
        {
