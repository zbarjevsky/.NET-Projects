...
namespace DynamicMap.NET.Internals
{
   ...
   {
      List<Dictionary<DynPoint, Tile>> Levels = new List<Dictionary<DynPoint, Tile>>(33);
      ...
      public TileMatrix()
      {
         ...
         {
             Levels.Add(new Dictionary<DynPoint, Tile>(55, new GPointComparer()));
         }
      }
      ...
      List<KeyValuePair<DynPoint, Tile>> tmp = new List<KeyValuePair<DynPoint, Tile>>(44);
      ...
      public Tile GetTileWithNoLock(int zoom, DynPoint p)
      {
         Tile ret = Tile.Empty;
      ...
      public Tile GetTileWithReadLock(int zoom, DynPoint p)
      {
         Tile ret = Tile.Empty;
