...
namespace DynamicMap.NET
{
...
#endif
   {
      ...
      public static double DistanceToLinealRoute(PointLatLng start, PointLatLng to, PointLatLng point)
      {
          ...
          double distance1 = MapProviders.MapProviders.EmptyProvider.Projection.
                             GetDistance(new PointLatLng(point.Lat, formulaLng), point);
          double distance2 = MapProviders.MapProviders.EmptyProvider.Projection.
      ...
      public double Distance
      {
         get
         {
            ...
            if(From.HasValue && To.HasValue)
            {
               ...
               {
                  distance += MapProviders.MapProviders.EmptyProvider.Projection.GetDistance(Points[i - 1], Points[i]);
               }
            }
