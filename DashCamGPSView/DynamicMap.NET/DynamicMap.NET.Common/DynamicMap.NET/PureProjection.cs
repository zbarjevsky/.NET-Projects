...
namespace DynamicMap.NET
{
   ...
   {
      readonly List<Dictionary<PointLatLng, DynPoint>> FromLatLngToPixelCache = new List<Dictionary<PointLatLng, DynPoint>>(33);
      readonly List<Dictionary<DynPoint, PointLatLng>> FromPixelToLatLngCache = new List<Dictionary<DynPoint, PointLatLng>>(33);

      public PureProjection()
      {
         for(int i = 0; i < FromLatLngToPixelCache.Capacity; i++)
         {
            FromLatLngToPixelCache.Add(new Dictionary<PointLatLng, DynPoint>());
            FromPixelToLatLngCache.Add(new Dictionary<DynPoint, PointLatLng>());
         }
      }
      ...
      /// size of tile
      /// </summary>
      public abstract DynSize TileSize
      {
         get;
      }
      ...
      /// <returns></returns>
      public abstract DynPoint FromLatLngToPixel(double lat, double lng, int zoom);
      ...
      public DynPoint FromLatLngToPixel(PointLatLng p, int zoom)
      {
      ...
      /// <param name="zoom"></param>
      /// <returns></returns>
      public DynPoint FromLatLngToPixel(PointLatLng p, int zoom, bool useCache)
      {
         if(useCache)
         {
      ...
      public PointLatLng FromPixelToLatLng(DynPoint p, int zoom)
      {
      ...
      /// <param name="zoom"></param>
      /// <returns></returns>
      public PointLatLng FromPixelToLatLng(DynPoint p, int zoom, bool useCache)
      {
         if(useCache)
         {
      ...
      /// <param name="p"></param>
      /// <returns></returns>
      public virtual DynPoint FromPixelToTileXY(DynPoint p)
      {
         return new DynPoint((long)(p.X / TileSize.Width), (long)(p.Y / TileSize.Height));
      }
      ...
      /// <param name="p"></param>
      /// <returns></returns>
      public virtual DynPoint FromTileXYToPixel(DynPoint p)
      {
         return new DynPoint((p.X * TileSize.Width), (p.Y * TileSize.Height));
      }
      ...
      /// <param name="zoom"></param>
      /// <returns></returns>
      public abstract DynSize GetTileMatrixMinXY(int zoom);
      ...
      /// <param name="zoom"></param>
      /// <returns></returns>
      public abstract DynSize GetTileMatrixMaxXY(int zoom);
      ...
      /// <param name="zoom"></param>
      /// <returns></returns>
      public virtual DynSize GetTileMatrixSizeXY(int zoom)
      {
         DynSize sMin = GetTileMatrixMinXY(zoom);
         DynSize sMax = GetTileMatrixMaxXY(zoom);

         return new DynSize(sMax.Width - sMin.Width + 1, sMax.Height - sMin.Height + 1);
      }
      ...
      {
         DynSize s = GetTileMatrixSizeXY(zoom);
      ...
      /// <param name="zoom"></param>
      /// <returns></returns>
      public virtual DynSize GetTileMatrixSizePixel(int zoom)
      {
         DynSize s = GetTileMatrixSizeXY(zoom);
         return new DynSize(s.Width * TileSize.Width, s.Height * TileSize.Height);
      }

      /// <summary>
      /// gets all tiles in rect at specific zoom
      /// </summary>
      public List<DynPoint> GetAreaTileList(RectLatLng rect, int zoom, int padding)
      {
         List<DynPoint> ret = new List<DynPoint>();

         DynPoint topLeft = FromPixelToTileXY(FromLatLngToPixel(rect.LocationTopLeft, zoom));
         DynPoint rightBottom = FromPixelToTileXY(FromLatLngToPixel(rect.LocationRightBottom, zoom));
      ...
      public double GetDistanceInPixels(DynPoint point1, DynPoint point2)
      {
