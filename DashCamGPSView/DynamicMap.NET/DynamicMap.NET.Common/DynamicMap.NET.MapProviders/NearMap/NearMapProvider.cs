...
namespace DynamicMap.NET.MapProviders
{
   ...
   /// </summary>
   public abstract class NearMapProviderBase : DynMapProvider
   {
      ...
      public new static int GetServerNum(DynPoint pos, int max)
      {
      ...
      public string GetSafeString(DynPoint pos)
      {
         #region -- source --
         /*
