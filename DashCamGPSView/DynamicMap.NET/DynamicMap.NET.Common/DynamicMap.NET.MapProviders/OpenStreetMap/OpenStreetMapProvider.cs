...
namespace DynamicMap.NET.MapProviders
{
    ...
    public abstract class OpenStreetMapProviderBase : DynMapProvider, RoutingProvider, GeocodingProvider
    {
        ...
        #region DynMapRoutingProvider Members
        ...
        public virtual MapRoute GetRoute(PointLatLng start, PointLatLng end, bool avoidHighways, bool walkingMode, int Zoom, bool getInstructions = false)
        {
            ...
            string routeXml = DynMaps.Instance.UseRouteCache ? Cache.Instance.GetContent(url, CacheType.RouteCache) : string.Empty;
        ...
        Placemark? GetPlacemarkFromReverseGeocoderUrl(string url, out GeoCoderStatusCode status)
        {
            ...
            try
            {
                string geo = DynMaps.Instance.UsePlacemarkCache ? Cache.Instance.GetContent(url, CacheType.PlacemarkCache) : string.Empty;
