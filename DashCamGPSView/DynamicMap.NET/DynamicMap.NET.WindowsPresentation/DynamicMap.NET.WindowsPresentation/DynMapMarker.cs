...
namespace DynamicMap.NET.WindowsPresentation
{
   ...
   public class DynMapMarker : INotifyPropertyChanged
   {
      ...
      public DynMapControl Map
      {
         get
         {
            if(Shape != null && map == null)
            {
               ...
               while(visual != null && !(visual is DynMapControl))
               {
                  visual = VisualTreeHelper.GetParent(visual);
               }

               map = visual as DynMapControl;
            }
      ...
      void UpdateLocalPosition()
      {
         if(Map != null)
         {
                DynPoint p = Map.FromLatLngToLocal(Position);
      ...
      /// </summary>
      /// <param name="m"></param>
      internal void ForceUpdateLocalPosition(DynMapControl m)
      {
         if(m != null)
         {
            map = m;
