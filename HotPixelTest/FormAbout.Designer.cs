namespace HotPixelTest
{
	partial class FormAbout
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_richTextBoxAbout.Text = "29 Jul 2010: About Form";
			...
			this.m_lblAbout.Size = new System.Drawing.Size(136, 13);
			this.m_lblAbout.TabIndex = 0;
			this.m_lblAbout.Text = "Dead Pixel Test v1.0.234.2";
			// 
			// m_lblCpyright
			// 
			...
			this.m_lblCpyright.Size = new System.Drawing.Size(152, 13);
			this.m_lblCpyright.TabIndex = 1;
			this.m_lblCpyright.Text = "Dead Pixel Test  Mark Z. 2010";
			// 
			// FormAbout
			// 
