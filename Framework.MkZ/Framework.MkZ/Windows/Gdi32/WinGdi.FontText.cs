...
namespace MkZ.Windows.WinGdi
{
	public static partial class Gdi32
	{
		...
		[PInvokeData("wingdi.h", MSDNShortId = "74f8fcb8-8ad4-47f2-a330-fa56713bdb37")]
		[return: MarshalAs(UnmanagedType.Bool)]
		public static extern bool ExtTextOut(HDC hdc, int x, int y, ETO options, [In, Optional] User32.RECT lprect, string lpString, uint c, [In, Optional] int[] lpDx);
  ...
  //          using var mem = new SafeAnysizeStruct<GLYPHSET>(l, nameof(GLYPHSET.cRanges));
		...
		public struct OUTLINETEXTMETRIC
		{
			...
			public User32.RECT otmrcFontBox;
