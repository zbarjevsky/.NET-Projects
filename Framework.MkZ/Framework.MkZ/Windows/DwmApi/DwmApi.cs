...
namespace MkZ.Windows.DwmApi
{
	...
	public static partial class DwmApi
	{
		...
		public enum DWMWINDOWATTRIBUTE
		{
			...
			/// </summary>
			[CorrespondingType(typeof(User32.RECT), CorrespondingAction.Get)]
		...
		public struct DWM_COLORIZATION_PARAMS
		{
			...
			public Gdi32.RGBQUAD clrColor;

			/// <summary>The ARGB after glow color.</summary>
			public Gdi32.RGBQUAD clrAfterGlow;
			...
			public Gdi32.RGBQUAD clrAfterGlowBalance;

			/// <summary>Determines how bright the blur is.</summary>
			public Gdi32.RGBQUAD clrBlurBalance;

			/// <summary>Determines how much the glass reflection is visible.</summary>
			public Gdi32.RGBQUAD clrGlassReflectionIntensity;
