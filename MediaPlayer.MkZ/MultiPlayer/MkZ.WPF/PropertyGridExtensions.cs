...
namespace MkZ.WinForms
{
    public static class PropertyGridExtensions
    {
        ...
        public static void MoveSplitterTo(this PropertyGrid propertyGrid, int xpos)
        {
            ...
            var res = method?.Invoke(gridView, new Object[] { xpos });
        }
        ...
        {
            //// Find all fields
            //var fields = propertyGrid.GetType().GetFields(BindingFlags.Instance | BindingFlags.NonPublic);
            //foreach (var field in fields)
            //{
            //    Console.WriteLine($"Field: {field.Name}"); // Debug field names
            //}
            ...
            // Use reflection to access the private property grid view
            // im .NET 8 the name is "_gridView", in .NET Framework 4.7 it is "gridView"
            var gridViewField = type.GetField("_gridView", BindingFlags.GetField | BindingFlags.Instance | BindingFlags.NonPublic);
            if (gridViewField == null) return null;
